# 🚀 Welcome to the Animals App (for testing) repository! 


It is an online store where you can create an account, log in, browse sections and products, and search as well.
